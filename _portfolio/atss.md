...
header:
  teaser: /assets/images/atss/atss.jpg
---
...
![Mass and CoG compliance](/assets/images/atss/MassCoGCompliance.png){: .align-center}
...
<div style="display: flex; justify-content: center; gap: 10px; flex-wrap: wrap;">
  <img src="/assets/images/atss/SC_mode_Lat1.png" alt="Lateral mode 1" style="width: 30%;">
  <img src="/assets/images/atss/SC_mode_Lat2.png" alt="Lateral mode 2" style="width: 30%;">
  <img src="/assets/images/atss/SC_mode_Lon.png" alt="Longitudinal mode" style="width: 30%;">
</div>
...
![Overfluxes](/assets/images/atss/overfluxes_completo.png){: .align-center}
...
![Dynamic coupling](/assets/images/atss/LVSCDynCoupling2D.png){: .align-center}
...
![Thermal deformation](/assets/images/atss/ThermalDeformation.png){: .align-center}
...
![Sine input](/assets/images/atss/X_input.png){: .align-center}

![Sine input detail](/assets/images/atss/X_input1.png){: .align-center}
...
![IP qualification](/assets/images/atss/IP_qualification.png){: .align-center}
...
![Severity comparison](/assets/images/atss/Severity_comparison.png){: .align-center}
...
![Buckling](/assets/images/atss/buckshape10_def.png){: .align-center}
